...
def handler(event, context):
    ...
    if event['session']['new'] == True:
        text = 'Привет! Я бот Экстренной первой помощи, назовите коротко и четко, с чем именно мы имеем дело! Например, "инфаркт". Также у меня всегда можно спросить "Что ты умеешь?" и "Помощь".'
